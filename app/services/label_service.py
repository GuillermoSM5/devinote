...
from app.models.label import Label, LableCreate
...
class LabelService:
    ...
    def create(self, owner_id: int, payload: LableCreate) -> Label:
    ...
    def delete(self, owner_id: int, label_id: int) -> None:
        ...
        if not label or label.owner_id != owner_id:
            raise HTTPException(
                status_code=404, detail="La etiqueta no existe o no esta autorizado")
